%% %% Analysis for Engine Noise without an external Audio
%% Initialization
clear; clc; close all;
...
%% Load audio files
[y1, ~] = audioread("C:\Users\naman\OneDrive\Desktop\ST_Work\ST_MainWork\Data_Collection\CarSound_without_extAudio\Microphone_Data\1min_no.wav", [1 sr*30]);
[y2, ~] = audioread("C:\Users\naman\OneDrive\Desktop\ST_Work\ST_MainWork\Data_Collection\Simulation_Of_Audio_Sound\Real_time_data\filtered_audio1.wav", [1 sr*30]);
